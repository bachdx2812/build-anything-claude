...
GATES=(
  ...
  "mech-rt-propagate::$MECH_DIR/e2e-multiclient.sh::gate-mechanical/rt-propagate.json"
  "mech-call::$MECH_DIR/e2e-call.sh::gate-mechanical/e2e-call.json"
  ...
  "spec-behavioral-binding::$SPEC_DIR/behavioral-binding-check.sh::gate-spec/behavioral-binding.json"
