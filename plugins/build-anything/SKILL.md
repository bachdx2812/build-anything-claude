...
| 5 | Mechanical Gates | `gate-mechanical` | GATE-10 GATE-11 GATE-16 lint type **+ GATE-25-E2E (v8.2)** **+ GATE-25-E2E-MOBILE + GATE-MOBILE-PERMS (v8.6, mobile-* only)** **+ GATE-25-E2E-BROWSER + GATE-BROWSER-WPT (v8.7, desktop-browser-* only)** | coverage / mutation / property below threshold / Playwright fail / Maestro fail / perms-mismatch / browser-e2e fail / wpt-conformance fail |
