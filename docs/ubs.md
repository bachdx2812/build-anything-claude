...
- **18 core Hard Laws** (LAW-01..17 + LAW-CL-95) + **9 v8.8 wiring/self-attestation laws** (LAW-WIRE, LAW-STUB, LAW-SUBSTANCE, LAW-SEED, LAW-AUTH-RT, LAW-ASSERT, LAW-TIER-CLOUD, LAW-WITNESS-TIER, LAW-REVERIFY) + **3 v8.9 behavioral laws** (LAW-RT-PROPAGATE, LAW-CALL, LAW-BEHAVIORAL-MUSTHAVE) + **2 v9.0 laws** (LAW-COV-EXEC coverage-trust, LAW-RT-DERIVE realtime-from-features) — inviolable. Violation = atom HALT + automation-ladder demotion.
